...
urlpatterns = [
    ...
    path('skujian_pengajuan', views_fakultas.skujian_pengajuan, name='skujian_pengajuan'),
    path('skujian_list', views_fakultas.skujian_list, name='skujian_list'),  
    ...
    path('usulan_ujian/<str:id>', views_fakultas.usulan_ujian, name='usulan_ujian'),  
    ...
    path('usulan_ujian_edit/<str:nim>', views_prodi.usulan_ujian_edit, name='usulan_ujian_edit'),   
    path('ujian/<str:filter>', views_prodi.ujian, name='ujian'), 
    ...
    path('usulan_ujian_reg', views_mhs.usulan_ujian_reg, name='usulan_ujian_reg'),
    path('usulan_ujian_reg_up', views_mhs.usulan_ujian_reg_up, name='usulan_ujian_reg_up'),
    ...
    path('print_pwu/<uuid:id>', print_persetujuan_waktu_ujian.print_persetujuan_waktu_ujian, name='print_persetujuan_waktu_ujian'),
